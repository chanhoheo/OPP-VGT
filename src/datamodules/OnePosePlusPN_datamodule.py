...
from src.datasets.OnePosePlusPN_dataset import OnePosePlusPNDataset
...
class OnePosePlusPNDataModule(LightningDataModule):
    ...
    def setup(self, stage=None):
        ...
        train_set = OnePosePlusPNDataset(

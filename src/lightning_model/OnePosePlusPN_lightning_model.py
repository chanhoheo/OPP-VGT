...
from src.models.OnePosePlusPN import OnePosePlusPN_model
from src.models.OnePosePlusPN.utils.fine_supervision import fine_supervision
from src.models.OnePosePlusPN.optimizers.optimizers import (
    build_optimizer,
    build_scheduler,
)
...
class PL_OnePosePlusPN(pl.LightningModule):
    def __init__(self, *args, **kwargs):
        super().__init__()

        self.save_hyperparameters()
        self.matcher = OnePosePlusPN_model(self.hparams["OnePosePlus"])

        self.pointnet2 = PointNet2_model()

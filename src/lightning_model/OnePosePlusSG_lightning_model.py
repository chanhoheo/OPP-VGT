...
from src.models.OnePosePlusSG import OnePosePlusSG_model
from src.models.OnePosePlusSG.utils.fine_supervision import fine_supervision
from src.models.OnePosePlusSG.optimizers.optimizers import (
    build_optimizer,
    build_scheduler,
)
...
class PL_OnePosePlusSG(pl.LightningModule):
    def __init__(self, *args, **kwargs):
        super().__init__()

        self.save_hyperparameters()
        self.matcher = OnePosePlusSG_model(self.hparams["OnePosePlus"])

...
def get_kpt_ann(
    ...
    """
    model_dir, anno_out_dir = get_default_path(cfg, outputs_dir) # model_dir: 'data/datasets/sfm_output/outputs_softmax_loftr_loftr/0410-huiyuan-box/sfm_ws/model'
    ...
    # filter_xyzs: (12123,3), avg_descriptors: (12123, 256)